function PageData(){
var visit = {'name':'Big Ben','distance': 1,'description':'It is a big clock tower that is currently under contruction','image':'image here'};
createVisitElement(visit);
}

function createVisitElement(visit){
const nameContainer = document.getElementById('name');
  //   nameContainer.innerText= "Big Ben";
